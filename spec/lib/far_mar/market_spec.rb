...
#    end
     ...
     it "finds the preferred vendor" do
        expect(market.preferred_vendor.id).to eq 5 # added .to_i
     end

     it "finds the worst vendor" do
        expect(market.worst_vendor.id).to eq 6 # added .to_i
     end
    ...
    it "finds the worst vendor by date" do
       expect(market.worst_vendor_date("2013-11-07").id).to eq 2
    end
